...
- ```C++
  ...
  // begin2 	容器2的开始迭代器
  // end2 	容器2的结束迭代器
  // destBegin 目标容器的开始迭代器
  set_intersection(iterator begin1, iterator end1, iterator begin2, iterator end2, iterator destBegin);
  ```
...
- ```C++
  ...
  // end2 容器2结束迭代器
  // destBegin 目标容器开始迭代器
  set_union(iterator begin1, iterator end1, iterator begin2, iterator end2, iterator destBegin);
  ```
...
- ```C++
  ...
  // end2 容器2的结束迭代器
  // destBegin 目标容器的开始迭代器
  set_difference(iterator begin1, iterator enn1, iterator begin2, iterator end2, iterator destBegin);
  ```
...
- 求差集的两个集合必须是有序序列
- 目标容器开辟的空间需要取前一个容器（容器1）的大小
- set_difference返回值即是差集中最后一个元素的位置的迭代器
